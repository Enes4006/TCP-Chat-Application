Simple TCP Chat Application 🖥️📡 -> Bu proje, Python'un socket kütüphanesini kullanarak temel bir istemci-server mesajlaşma uygulaması oluşturur. TCP protokolü ile iki taraf arasında veri aktarımını sağlar.
